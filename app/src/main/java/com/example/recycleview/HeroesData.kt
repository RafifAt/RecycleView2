...
object HeroesData {
    ...
    private val data = arrayOf(
        arrayOf(
            ...
            "https://upload.wikimedia.org/wikipedia/commons/8/87/Ahmad_Dahlan.jph"
        ),
        arrayOf(
            "Ahmad Yani",
        ...
        arrayOf(
            "Gatot Soebroto",
            "Jenderal TNI (Purn.) Gatot Soebroto (lahir di Sumpiuh, Banyumas, Jawa Tengah, 10 Oktober 1907 – meninggal diJakarta, 11 Juni 1962 pada umur 54 tahun) adalah tokohperjuangan militer Indonesia dalam merebut kemerdekaan dan jugapahlawan nasional Indonesia. Ia dimakamkan di Ungaran, kabupatenSemarang.",
